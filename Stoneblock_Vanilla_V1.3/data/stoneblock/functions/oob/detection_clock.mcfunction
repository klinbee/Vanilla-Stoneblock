...
execute as @a as @s at @s if dimension the_nether if entity @a[gamemode=survival,y=256,dy=64,scores={spawnset=1}] run execute in the_nether run function stoneblock:oob/nether
